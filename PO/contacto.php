                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input id="name" class="form-control" name="name" type="text" value="" placeholder="Nome" required/>
                                    </div>
                                    <div class="form-group">
                                        <input id="email" class="form-control" name="email" type="text" value="" placeholder="E-Mail" required/>
                                    </div>
                                    <div class="form-group">
                                        <input id="cargo" class="form-control" name="cargo" type="text" value="" placeholder="Cargo" required/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input id="phone" class="form-control" name="phone" type="text" value="" placeholder="Telefone" required/>
                                    </div>
                                    <div class="form-group">
                                        <input id="empresa" class="form-control" name="empresa" type="text" value="" placeholder="Empresa" required/>
                                    </div>
                                    <div class="form-group">
                                        <input id="consulta" class="form-control" name="consulta" type="text" value="" placeholder="Tipo de consulta" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group" style="float:right;">
                                        <button style="margin-top:5px;" class="btn btn-grey">Enviar</button>
                                    </div>
                                </div>
                            </div>
                        </form>
