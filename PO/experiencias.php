<?php
    ...
    $arrProducts = array();
     if (empty($_GET['cat'])){
        $query = "SELECT idProduct, title3, images, cover, category, orderby FROM products ORDER BY idProduct DESC";
    }
    if (!empty($_GET['cat'])){
        $query = "SELECT idProduct, title3, images, cover, category, orderby FROM products WHERE category = '{$_GET['cat']}' ORDER BY idProduct DESC";
    }
                ...
                <div class="row filters">
                    <div class="row">
                        ...
                        <div class="col-md-3 filter" data-filter=".botaderos">
                            <div class="filterbox">
                                <a href="experiencias.php?cat=botaderos">Cestos</a>
                            </div>
                        </div>
                        <div class="col-md-3 filter" data-filter=".depie">
                            <div class="filterbox">
                                <a href="experiencias.php?cat=depie">Displays de Chão</a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 filter" data-filter=".islas">
                            <div class="filterbox">
                                <a href="experiencias.php?cat=islas">Ilhas</a>
                            </div>
                        </div>
                        <div class="col-md-3 filter" data-filter=".mostrador">
                            <div class="filterbox">
                                <a href="experiencias.php?cat=mostrador">Displays de Balcão</a>
                            </div>
                        </div>
                        <div class="col-md-3 filter" data-filter=".automaticos">
                            <div class="filterbox">
                                <a href="experiencias.php?cat=auotmaticos">Displays automáticos</a>
                            </div>
                        </div>
