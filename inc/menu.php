    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-3 lang visible-lg">
                        <a class="sublang" data-toggle="modal" data-target="#langselect" href="#">ESP <div class="flag" style="background-image:url(../img/arg.png);"></div> <i class="fa fa-caret-down"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 menuinside">
                ...
                <a style="padding:0;" href="contacto.php">Contacto</a>
                <a class="visible-xs sublang" data-toggle="modal" data-target="#langselect" href="#">ESP <i class="fa fa-caret-down"></i></a>
            </div>
        </div>
    </div>
</div>
